...
const REALM_THRESHOLDS = [
  ...
  { realm: 6, name: '第六境·合道', stages: [
    { type: 'ming', name: '明局', threshold: 2200 },
    { type: 'an', name: '暗局', threshold: 3300, modifiers: ['no_bomb_qi', 'tianming_hidden'] },
    { type: 'zong', name: '宗主局', threshold: 5000, boss: 'gui' },
  ]},
  { realm: 7, name: '第七境·绝巅', stages: [
    { type: 'ming', name: '明局', threshold: 3200 },
    { type: 'an', name: '暗局', threshold: 4800, modifiers: ['enemy_boost', 'qi_cap_down'] },
    { type: 'zong', name: '宗主局', threshold: 7200, boss: 'void' },
  ]},
  { realm: 8, name: '第八境·归一', stages: [
    { type: 'ming', name: '明局', threshold: 4600 },
    { type: 'an', name: '暗局', threshold: 7000, modifiers: ['hand_minus_2', 'xinmo_start'] },
    { type: 'zong', name: '宗主局', threshold: 10500, boss: 'paizong' },
  ]},
];
...
const DIFFICULTIES = [
  ...
  { id: 'hard', name: '险途', desc: '门槛×1.25，守关者更狠，阅历+40%', mult: 1.25, reward: 1.4, enemy: 1.2, unlockYueli: 80 },
  { id: 'master', name: '宗师', desc: '门槛×1.55，心魔易涨，阅历+80%，掉落更好', mult: 1.55, reward: 1.8, enemy: 1.4, unlockYueli: 300 },
  { id: 'legend', name: '传说', desc: '门槛×2.0，极限构筑挑战，阅历×2.5', mult: 2.0, reward: 2.5, enemy: 1.65, unlockYueli: 900 },
];
...
const ACHIEVEMENTS = [
  ...
  { id: 'puzzle_all', name: '残谱尽解', desc: '通关全部残局', yueli: 150, cat: 'challenge', icon: 'skill', tier: 'gold', progress: { type: 'puzzlesFull', target: 0 } },
 ...
 * star: 1–3 难度星
 * goal: clear — 我方分数先到门槛
 * maxRounds: 超时判负（守关者为静默，主要压玩家节奏）
 * starsByRound: [三星上限回合, 二星上限回合] — 更慢只能拿 1 星
 */
const PUZZLE_POOL = [
  {
    id: 'p01_open',
